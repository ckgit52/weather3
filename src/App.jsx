...
const Api_key = "37fa9304349edd22e0256fe99d865d23";
...
const App = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-900 to-pink-900 h-screen grid place-items-center">
      <div className=" w-full bg-black text-white sm:w-96 p-4 rounded-md">
        <div className="flex bg-white items-center justify-between rounded-md">
          <input
            type="text"
            ref={inputRef}
            placeholder="Enter Your City..."
            className="text-xl text-black border-b
          p-1 border-gray-300 font-semibold uppercase flex-1 rounded-md"
          />
